---
name: context-brief
description: Use when starting a new task and need to gather the right context first. Assembles a context package without starting the task.
...
### Essential Context
- **PR**: cfw-database-manager PR #88 — adds index on `hierarchy_positions(space_id)`
- **JIRA**: YIMX-1850 — "Slow queries on hierarchy_positions table"
...
### Supporting Context
- Current instance: db-custom-1-3840 (3.75 GB RAM)
